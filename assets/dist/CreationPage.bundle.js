...
/***/ "./src/js/CreationPage.js":
/*!********************************!*\
  !*** ./src/js/CreationPage.js ***!
  \********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _utils_AbstractMBP_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/AbstractMBP.js */ \"./src/js/utils/AbstractMBP.js\");\n/* harmony import */ var _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/Utils.js */ \"./src/js/utils/Utils.js\");\nfunction _typeof(o) { \"@babel/helpers - typeof\"; return _typeof = \"function\" == typeof Symbol && \"symbol\" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && \"function\" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? \"symbol\" : typeof o; }, _typeof(o); }\nfunction _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError(\"Cannot call a class as a function\"); }\nfunction _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, \"value\" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }\nfunction _createClass(e, r, t) { return r && _defineProperties(e.prototype, r), t && _defineProperties(e, t), Object.defineProperty(e, \"prototype\", { writable: !1 }), e; }\nfunction _toPropertyKey(t) { var i = _toPrimitive(t, \"string\"); return \"symbol\" == _typeof(i) ? i : i + \"\"; }\nfunction _toPrimitive(t, r) { if (\"object\" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || \"default\"); if (\"object\" != _typeof(i)) return i; throw new TypeError(\"@@toPrimitive must return a primitive value.\"); } return (\"string\" === r ? String : Number)(t); }\nfunction _callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, _isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }\nfunction _possibleConstructorReturn(t, e) { if (e && (\"object\" == _typeof(e) || \"function\" == typeof e)) return e; if (void 0 !== e) throw new TypeError(\"Derived constructors may only return object or undefined\"); return _assertThisInitialized(t); }\nfunction _assertThisInitialized(e) { if (void 0 === e) throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); return e; }\nfunction _isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }\nfunction _getPrototypeOf(t) { return _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function (t) { return t.__proto__ || Object.getPrototypeOf(t); }, _getPrototypeOf(t); }\nfunction _inherits(t, e) { if (\"function\" != typeof e && null !== e) throw new TypeError(\"Super expression must either be null or a function\"); t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } }), Object.defineProperty(t, \"prototype\", { writable: !1 }), e && _setPrototypeOf(t, e); }\nfunction _setPrototypeOf(t, e) { return _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, _setPrototypeOf(t, e); }\n\n\nvar CreationPage = /*#__PURE__*/function (_AbstractMBP) {\n  function CreationPage() {\n    var _this;\n    _classCallCheck(this, CreationPage);\n    _this = _callSuper(this, CreationPage);\n    _this._init().then(_this._initializeCreationPage.bind(_this)).then(_this._translateCreationPage.bind(_this)).then(_this._handleEvents.bind(_this)).then(_this._makeSceneVisible.bind(_this));\n    return _this;\n  }\n  _inherits(CreationPage, _AbstractMBP);\n  return _createClass(CreationPage, [{\n    key: \"_initializeCreationPage\",\n    value: function _initializeCreationPage() {\n      var _this2 = this;\n      return new Promise(function (resolve) {\n        _this2._dom = document.getElementById('scene');\n        resolve();\n      });\n    }\n  }, {\n    key: \"_translateCreationPage\",\n    value: function _translateCreationPage() {\n      var _this3 = this;\n      return new Promise(function (resolve) {\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].replaceNlsString(_this3._dom, 'ORG_MANTRA', _this3._nls.creation.mantra);\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].replaceNlsString(_this3._dom, 'ORG_DESCRIPTION', _this3._nls.creation.description);\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].replaceNlsString(_this3._dom, 'ORG_DISCOVER', _this3._nls.creation.discover);\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].replaceNlsString(_this3._dom, 'ART_MUSIC', _this3._nls.creation.music);\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].replaceNlsString(_this3._dom, 'ART_VIDEO', _this3._nls.creation.video);\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].replaceNlsString(_this3._dom, 'ART_PODCAST', _this3._nls.creation.podcast);\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].replaceNlsString(_this3._dom, 'ART_PHOTO', _this3._nls.creation.photo);\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].replaceNlsString(_this3._dom, 'ART_MERCH', _this3._nls.creation.merch);\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].replaceNlsString(_this3._dom, 'ART_SOFTWARE', _this3._nls.creation.software);\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].replaceNlsString(_this3._dom, 'ART_CATALOG', _this3._nls.creation.catalog);\n        resolve();\n      });\n    }\n  }, {\n    key: \"_handleEvents\",\n    value: function _handleEvents() {\n      var _this4 = this;\n      return new Promise(function (resolve) {\n        _this4._dom.querySelector('#music').addEventListener('click', _this4._updateLocation.bind(_this4, _this4._nls.translatedUrl.music));\n        _this4._dom.querySelector('#video').addEventListener('click', _this4._updateLocation.bind(_this4, _this4._nls.translatedUrl.video));\n        _this4._dom.querySelector('#podcast').addEventListener('click', _this4._updateLocation.bind(_this4, _this4._nls.translatedUrl.podcast));\n        _this4._dom.querySelector('#photo').addEventListener('click', _this4._updateLocation.bind(_this4, _this4._nls.translatedUrl.photo));\n        _this4._dom.querySelector('#merch').addEventListener('click', _this4._updateLocation.bind(_this4, _this4._nls.translatedUrl.merch));\n        _this4._dom.querySelector('#software').addEventListener('click', _this4._updateLocation.bind(_this4, _this4._nls.translatedUrl.software));\n        //this._dom.querySelector('#catalog').addEventListener('click', this._updateLocation.bind(this, this._nls.translatedUrl.catalog));\n        resolve();\n      });\n    }\n  }]);\n}(_utils_AbstractMBP_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CreationPage);\nwindow.CreationPage = new CreationPage();\n\n//# sourceURL=webpack://messe-basse-production.com/./src/js/CreationPage.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/js/CreationPage.js");
/******/ 	window.CreationPage = __webpack_exports__["default"];
/******/ 	
/******/ })()
;