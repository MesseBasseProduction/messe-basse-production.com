...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _utils_AbstractMBP_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/AbstractMBP.js */ \"./src/js/utils/AbstractMBP.js\");\n/* harmony import */ var _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/Utils.js */ \"./src/js/utils/Utils.js\");\nfunction _typeof(o) { \"@babel/helpers - typeof\"; return _typeof = \"function\" == typeof Symbol && \"symbol\" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && \"function\" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? \"symbol\" : typeof o; }, _typeof(o); }\nfunction _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError(\"Cannot call a class as a function\"); }\nfunction _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, \"value\" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }\nfunction _createClass(e, r, t) { return r && _defineProperties(e.prototype, r), t && _defineProperties(e, t), Object.defineProperty(e, \"prototype\", { writable: !1 }), e; }\nfunction _toPropertyKey(t) { var i = _toPrimitive(t, \"string\"); return \"symbol\" == _typeof(i) ? i : i + \"\"; }\nfunction _toPrimitive(t, r) { if (\"object\" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || \"default\"); if (\"object\" != _typeof(i)) return i; throw new TypeError(\"@@toPrimitive must return a primitive value.\"); } return (\"string\" === r ? String : Number)(t); }\nfunction _callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, _isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }\nfunction _possibleConstructorReturn(t, e) { if (e && (\"object\" == _typeof(e) || \"function\" == typeof e)) return e; if (void 0 !== e) throw new TypeError(\"Derived constructors may only return object or undefined\"); return _assertThisInitialized(t); }\nfunction _assertThisInitialized(e) { if (void 0 === e) throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); return e; }\nfunction _isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }\nfunction _getPrototypeOf(t) { return _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function (t) { return t.__proto__ || Object.getPrototypeOf(t); }, _getPrototypeOf(t); }\nfunction _inherits(t, e) { if (\"function\" != typeof e && null !== e) throw new TypeError(\"Super expression must either be null or a function\"); t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } }), Object.defineProperty(t, \"prototype\", { writable: !1 }), e && _setPrototypeOf(t, e); }\nfunction _setPrototypeOf(t, e) { return _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, _setPrototypeOf(t, e); }\n\n\nvar EventPage = /*#__PURE__*/function (_AbstractMBP) {\n  function EventPage() {\n    var _this;\n    _classCallCheck(this, EventPage);\n    _this = _callSuper(this, EventPage);\n    _this._eventData = {};\n    _this._init().then(_this._initializeEventPage.bind(_this)).then(_this._buildEventPage.bind(_this)).then(_this._makeSceneVisible.bind(_this));\n    return _this;\n  }\n  _inherits(EventPage, _AbstractMBP);\n  return _createClass(EventPage, [{\n    key: \"_initializeEventPage\",\n    value: function _initializeEventPage() {\n      var _this2 = this;\n      return new Promise(function (resolve, reject) {\n        _this2._dom = document.querySelector('.events-wrapper');\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].fetchData('events').then(function (data) {\n          _this2._eventData = data;\n          resolve();\n        })[\"catch\"](reject);\n      });\n    }\n  }, {\n    key: \"_buildEventPage\",\n    value: function _buildEventPage() {\n      var _this3 = this;\n      return new Promise(function (resolve) {\n        // First we determine user's local date formatted YYY-MM-DD\n        _this3._now = new Date();\n        var offset = _this3._now.getTimezoneOffset();\n        _this3._now = new Date(_this3._now.getTime() - offset * 60 * 1000);\n        _this3._now = _this3._now.toISOString().split('T')[0];\n        var hasUpcoming = false; // To know if the H1 requires to be added for upcoming event\n        var hasPast = false;\n        var years = {};\n        for (var i = 0; i < _this3._eventData.events.length; ++i) {\n          // First case, the event hasn't occured yet, it is an upcoming one\n          if (hasUpcoming === false && _this3._eventData.events[i].date >= _this3._now) {\n            hasUpcoming = true;\n            var header = document.createElement('H1');\n            header.innerHTML = _this3._nls.events.upcoming;\n            _this3._dom.appendChild(header);\n          } else if (_this3._eventData.events[i].date < _this3._now && hasPast === false) {\n            hasPast = true;\n            var _header = document.createElement('H1');\n            _header.innerHTML = _this3._nls.events.past;\n            _this3._dom.appendChild(_header);\n          }\n          // Now check for year header in past events section\n          var studiedYear = _this3._eventData.events[i].date.slice(0, 4);\n          if (!years[studiedYear] && _this3._eventData.events[i].date < _this3._now) {\n            years[studiedYear] = studiedYear;\n            var _header2 = document.createElement('H2');\n            _header2.innerHTML = studiedYear;\n            _this3._dom.appendChild(_header2);\n          }\n          var event = _this3.__buildEventDOM(_this3._eventData.events[i]);\n          _this3._dom.appendChild(event);\n        }\n        resolve();\n      });\n    }\n  }, {\n    key: \"__buildEventDOM\",\n    value: function __buildEventDOM(data) {\n      var event = document.createElement('DIV');\n      event.classList.add('event');\n      event.classList.add('item');\n      var image = document.createElement('IMG');\n      image.src = data.image;\n      var content = document.createElement('DIV');\n      content.classList.add('content');\n      content.innerHTML = \"\\n      <span>\\n        <h1><a href=\\\"\".concat(data.link, \"\\\" target=\\\"_blank\\\" rel=\\\"noreferrer noopener\\\">\").concat(data.title, \"</a></h1>\\n        <h2><i>\").concat(_utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].formatDate(data.date, this._lang), \" \\u2013 \").concat(data.place, \"</i></h2>\\n      </span>\\n      <p>\").concat(data.description[this._lang], \"</p>\\n    \");\n      content.innerHTML.replace('\\n', '');\n      var starring = document.createElement('DIV');\n      starring.classList.add('starring');\n      for (var i = 0; i < data.starring.length; ++i) {\n        var artist = document.createElement('A');\n        artist.innerHTML = data.starring[i].name;\n        artist.href = data.starring[i].url;\n        artist.target = '_blank';\n        artist.rel = 'noreferrer noopener';\n        starring.appendChild(artist);\n      }\n      event.appendChild(image);\n      event.appendChild(content);\n      content.appendChild(starring);\n      return event;\n    }\n  }]);\n}(_utils_AbstractMBP_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (EventPage);\nwindow.EventPage = new EventPage();\n\n//# sourceURL=webpack://messe-basse-production.com/./src/js/EventPage.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/js/EventPage.js");
/******/ 	window.EventPage = __webpack_exports__["default"];
/******/ 	
/******/ })()
;