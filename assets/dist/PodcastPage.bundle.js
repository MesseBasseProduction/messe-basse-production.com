...
/***/ "./src/js/subpages/PodcastPage.js":
/*!****************************************!*\
  !*** ./src/js/subpages/PodcastPage.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _utils_AbstractMBP_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/AbstractMBP.js */ \"./src/js/utils/AbstractMBP.js\");\n/* harmony import */ var _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/Utils.js */ \"./src/js/utils/Utils.js\");\nfunction _typeof(o) { \"@babel/helpers - typeof\"; return _typeof = \"function\" == typeof Symbol && \"symbol\" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && \"function\" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? \"symbol\" : typeof o; }, _typeof(o); }\nfunction _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError(\"Cannot call a class as a function\"); }\nfunction _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, \"value\" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }\nfunction _createClass(e, r, t) { return r && _defineProperties(e.prototype, r), t && _defineProperties(e, t), Object.defineProperty(e, \"prototype\", { writable: !1 }), e; }\nfunction _toPropertyKey(t) { var i = _toPrimitive(t, \"string\"); return \"symbol\" == _typeof(i) ? i : i + \"\"; }\nfunction _toPrimitive(t, r) { if (\"object\" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || \"default\"); if (\"object\" != _typeof(i)) return i; throw new TypeError(\"@@toPrimitive must return a primitive value.\"); } return (\"string\" === r ? String : Number)(t); }\nfunction _callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, _isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }\nfunction _possibleConstructorReturn(t, e) { if (e && (\"object\" == _typeof(e) || \"function\" == typeof e)) return e; if (void 0 !== e) throw new TypeError(\"Derived constructors may only return object or undefined\"); return _assertThisInitialized(t); }\nfunction _assertThisInitialized(e) { if (void 0 === e) throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); return e; }\nfunction _isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }\nfunction _getPrototypeOf(t) { return _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function (t) { return t.__proto__ || Object.getPrototypeOf(t); }, _getPrototypeOf(t); }\nfunction _inherits(t, e) { if (\"function\" != typeof e && null !== e) throw new TypeError(\"Super expression must either be null or a function\"); t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } }), Object.defineProperty(t, \"prototype\", { writable: !1 }), e && _setPrototypeOf(t, e); }\nfunction _setPrototypeOf(t, e) { return _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, _setPrototypeOf(t, e); }\n\n\nvar PodcastPage = /*#__PURE__*/function (_AbstractMBP) {\n  function PodcastPage() {\n    var _this;\n    _classCallCheck(this, PodcastPage);\n    _this = _callSuper(this, PodcastPage);\n    _this._podcastData = {};\n    _this._init().then(_this._initializePodcastPage.bind(_this)).then(_this._translatePodcastPage.bind(_this)).then(_this._buildPodcastPage.bind(_this)).then(_this._handleEvents.bind(_this)).then(_this._makeSceneVisible.bind(_this));\n    return _this;\n  }\n  _inherits(PodcastPage, _AbstractMBP);\n  return _createClass(PodcastPage, [{\n    key: \"_initializePodcastPage\",\n    value: function _initializePodcastPage() {\n      var _this2 = this;\n      return new Promise(function (resolve, reject) {\n        _this2._dom = document.getElementById('scene');\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].fetchData('podcast').then(function (data) {\n          _this2._podcastData = data.podcast;\n          resolve();\n        })[\"catch\"](reject);\n      });\n    }\n  }, {\n    key: \"_translatePodcastPage\",\n    value: function _translatePodcastPage() {\n      var _this3 = this;\n      return new Promise(function (resolve) {\n        var nav = document.getElementById('navigation');\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].replaceNlsString(nav, 'NAVBAR_CREATION', _this3._nls.creation.podcast);\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].replaceNlsString(_this3._dom, 'VIDEO_TITLE', _this3._nls.video.title);\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].replaceNlsString(_this3._dom, 'VIDEO_DESCRIPTION', _this3._nls.video.description);\n        resolve();\n      });\n    }\n  }, {\n    key: \"_buildPodcastPage\",\n    value: function _buildPodcastPage() {\n      var _this4 = this;\n      return new Promise(function (resolve) {\n        for (var i = 0; i < _this4._podcastData.length; ++i) {\n          var podcast = document.createElement('DIV');\n          podcast.classList.add('collection');\n          var title = document.createElement('H2');\n          title.innerHTML = _this4._podcastData[i].name;\n          var description = document.createElement('P');\n          description.innerHTML = _this4._podcastData[i].description[_this4._lang];\n          podcast.appendChild(title);\n          podcast.appendChild(description);\n          var episodes = document.createElement('DIV');\n          for (var j = 0; j < _this4._podcastData[i].episodes.length; ++j) {\n            var episode = document.createElement('DIV');\n            episode.classList.add('item');\n            var image = document.createElement('IMG');\n            image.src = _this4._podcastData[i].episodes[j].image;\n            var content = document.createElement('DIV');\n            content.classList.add('content');\n            content.innerHTML = \"\\n            <span>\\n              <h1><a href=\\\"\".concat(_this4._podcastData[i].episodes[j].link, \"\\\" target=\\\"_blank\\\" rel=\\\"noreferrer noopener\\\">\").concat(_this4._podcastData[i].episodes[j].title, \"</a></h1>\\n            </span>\\n            <p>\").concat(_this4._podcastData[i].episodes[j].description[_this4._lang], \"</p>\\n          \");\n            content.innerHTML.replace('\\n', '');\n            var links = document.createElement('DIV');\n            links.classList.add('links');\n            for (var k = 0; k < _this4._podcastData[i].episodes[j].links.length; ++k) {\n              var link = document.createElement('A');\n              link.innerHTML = _this4._podcastData[i].episodes[j].links[k].name;\n              link.href = _this4._podcastData[i].episodes[j].links[k].url;\n              link.target = '_blank';\n              link.rel = 'noreferrer noopener';\n              links.appendChild(link);\n            }\n            content.appendChild(links);\n            episode.appendChild(image);\n            episode.appendChild(content);\n            episodes.appendChild(episode);\n          }\n          podcast.appendChild(episodes);\n          _this4._dom.querySelector('#podcast-list').appendChild(podcast);\n        }\n        resolve();\n      });\n    }\n  }, {\n    key: \"_handleEvents\",\n    value: function _handleEvents() {\n      var _this5 = this;\n      return new Promise(function (resolve) {\n        _this5._dom.querySelector('#back-button').addEventListener('click', _this5._updateLocation.bind(_this5, 'creation'));\n        resolve();\n      });\n    }\n  }]);\n}(_utils_AbstractMBP_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PodcastPage);\nwindow.PodcastPage = new PodcastPage();\n\n//# sourceURL=webpack://messe-basse-production.com/./src/js/subpages/PodcastPage.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/js/subpages/PodcastPage.js");
/******/ 	window.PodcastPage = __webpack_exports__["default"];
/******/ 	
/******/ })()
;