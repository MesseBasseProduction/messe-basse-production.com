...
/***/ "./src/js/subpages/SoftwarePage.js":
/*!*****************************************!*\
  !*** ./src/js/subpages/SoftwarePage.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _utils_AbstractMBP_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/AbstractMBP.js */ \"./src/js/utils/AbstractMBP.js\");\n/* harmony import */ var _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/Utils.js */ \"./src/js/utils/Utils.js\");\nfunction _typeof(o) { \"@babel/helpers - typeof\"; return _typeof = \"function\" == typeof Symbol && \"symbol\" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && \"function\" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? \"symbol\" : typeof o; }, _typeof(o); }\nfunction _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError(\"Cannot call a class as a function\"); }\nfunction _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, \"value\" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }\nfunction _createClass(e, r, t) { return r && _defineProperties(e.prototype, r), t && _defineProperties(e, t), Object.defineProperty(e, \"prototype\", { writable: !1 }), e; }\nfunction _toPropertyKey(t) { var i = _toPrimitive(t, \"string\"); return \"symbol\" == _typeof(i) ? i : i + \"\"; }\nfunction _toPrimitive(t, r) { if (\"object\" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || \"default\"); if (\"object\" != _typeof(i)) return i; throw new TypeError(\"@@toPrimitive must return a primitive value.\"); } return (\"string\" === r ? String : Number)(t); }\nfunction _callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, _isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }\nfunction _possibleConstructorReturn(t, e) { if (e && (\"object\" == _typeof(e) || \"function\" == typeof e)) return e; if (void 0 !== e) throw new TypeError(\"Derived constructors may only return object or undefined\"); return _assertThisInitialized(t); }\nfunction _assertThisInitialized(e) { if (void 0 === e) throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); return e; }\nfunction _isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }\nfunction _getPrototypeOf(t) { return _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function (t) { return t.__proto__ || Object.getPrototypeOf(t); }, _getPrototypeOf(t); }\nfunction _inherits(t, e) { if (\"function\" != typeof e && null !== e) throw new TypeError(\"Super expression must either be null or a function\"); t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } }), Object.defineProperty(t, \"prototype\", { writable: !1 }), e && _setPrototypeOf(t, e); }\nfunction _setPrototypeOf(t, e) { return _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, _setPrototypeOf(t, e); }\n\n\nvar SoftwarePage = /*#__PURE__*/function (_AbstractMBP) {\n  function SoftwarePage() {\n    var _this;\n    _classCallCheck(this, SoftwarePage);\n    _this = _callSuper(this, SoftwarePage);\n    _this._softwareData = {};\n    _this._init().then(_this._initializeSoftwarePage.bind(_this)).then(_this._translateSoftwarePage.bind(_this)).then(_this._buildSoftwarePage.bind(_this)).then(_this._handleEvents.bind(_this)).then(_this._makeSceneVisible.bind(_this));\n    return _this;\n  }\n  _inherits(SoftwarePage, _AbstractMBP);\n  return _createClass(SoftwarePage, [{\n    key: \"_initializeSoftwarePage\",\n    value: function _initializeSoftwarePage() {\n      var _this2 = this;\n      return new Promise(function (resolve, reject) {\n        _this2._dom = document.getElementById('scene');\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].fetchData('software').then(function (data) {\n          _this2._softwareData = data;\n          resolve();\n        })[\"catch\"](reject);\n      });\n    }\n  }, {\n    key: \"_translateSoftwarePage\",\n    value: function _translateSoftwarePage() {\n      var _this3 = this;\n      return new Promise(function (resolve) {\n        var nav = document.getElementById('navigation');\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].replaceNlsString(nav, 'NAVBAR_CREATION', _this3._nls.creation.software);\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].replaceNlsString(_this3._dom, 'SOFTWARE_TITLE', _this3._nls.software.title);\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].replaceNlsString(_this3._dom, 'SOFTWARE_DESCRIPTION1', _this3._nls.software.description1);\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].replaceNlsString(_this3._dom, 'SOFTWARE_DESCRIPTION2', _this3._nls.software.description2);\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].replaceNlsString(_this3._dom, 'SOFTWARE_CREATION', _this3._nls.software.creation);\n        _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].replaceNlsString(_this3._dom, 'SOFTWARE_ARTISTS_WEBSITE', _this3._nls.software.artistsWebsite);\n        resolve();\n      });\n    }\n  }, {\n    key: \"_buildSoftwarePage\",\n    value: function _buildSoftwarePage() {\n      var _this4 = this;\n      return new Promise(function (resolve) {\n        var _loop = function _loop() {\n          var website = document.createElement('DIV');\n          website.classList.add('website');\n          website.dataset.url = _this4._softwareData.creation[i].url;\n          website.innerHTML = \"\\n          <img src=\\\"\".concat(_this4._softwareData.creation[i].image, \"\\\" alt=\\\"mbp-website\\\">\\n          <h2>\").concat(_this4._softwareData.creation[i].name, \"</h2>\\n          <p>\").concat(_this4._softwareData.creation[i].bio[_this4._lang], \"</p>\\n        \");\n          website.addEventListener('click', function () {\n            window.open(website.dataset.url, '_blank', 'noopener, noreferrer');\n          });\n          _this4._dom.querySelector('#mbp-website-grid').appendChild(website);\n        };\n        for (var i = 0; i < _this4._softwareData.creation.length; ++i) {\n          _loop();\n        }\n        var _loop2 = function _loop2() {\n          var website = document.createElement('DIV');\n          website.classList.add('website');\n          website.dataset.url = _this4._softwareData.artists[_i].url;\n          website.innerHTML = \"\\n          <img src=\\\"\".concat(_this4._softwareData.artists[_i].image, \"\\\" alt=\\\"mbp-website\\\">\\n          <h2>\").concat(_this4._softwareData.artists[_i].name, \"</h2>\\n        \");\n          website.addEventListener('click', function () {\n            window.open(website.dataset.url, '_blank', 'noopener, noreferrer');\n          });\n          _this4._dom.querySelector('#band-website-grid').appendChild(website);\n        };\n        for (var _i = 0; _i < _this4._softwareData.artists.length; ++_i) {\n          _loop2();\n        }\n        resolve();\n      });\n    }\n  }, {\n    key: \"_handleEvents\",\n    value: function _handleEvents() {\n      var _this5 = this;\n      return new Promise(function (resolve) {\n        _this5._dom.querySelector('#back-button').addEventListener('click', _this5._updateLocation.bind(_this5, 'creation'));\n        resolve();\n      });\n    }\n  }]);\n}(_utils_AbstractMBP_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SoftwarePage);\nwindow.SoftwarePage = new SoftwarePage();\n\n//# sourceURL=webpack://messe-basse-production.com/./src/js/subpages/SoftwarePage.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/js/subpages/SoftwarePage.js");
/******/ 	window.SoftwarePage = __webpack_exports__["default"];
/******/ 	
/******/ })()
;